          ...
          <>
            {
              ...
              <>
                ...
                <p style={{color: 'lightgrey', textDecoration: 'underline', cursor: 'pointer'}} onClick={() => setLoadStamps({isLoaded: false, id: ''})}>Show Less</p>
                </>
                  :
                  <> 
                  {
                  ...
                  }
                  {
                    timeStamps.length < 4 ? '' :
                    <p 
                      style={{color: 'lightgrey', textDecoration: 'underline', cursor: 'pointer', width: '100px'}} 
                      onClick={() => setLoadStamps({isLoaded: true, id: episodeId})}>
